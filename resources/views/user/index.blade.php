...
<head>
  ...
  <title>Antariksa Mengaji | Dashboard</title>
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Status</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i> Materi</a></li>
            <li><a href="pages/layout/fixed.html"><i class="fa fa-circle-o"></i> Kuis</a></li>
            <li><a href="pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Nilai</a></li>
          </ul>
        </li>
        <li>
